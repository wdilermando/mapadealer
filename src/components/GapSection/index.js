...
const GapSection = () => {
    return (
        <InfoSec>
            <DestacWrapper>
                <TitleSection fSize={'32px'}>NÓS GUIAMOS VOCÊ AO LONGO DESSA JORNADA</TitleSection>
            </DestacWrapper>
            <ContainerCustom>
                <Row className="justify-content-md-center mt-5">
                    <Col lg="8" xs="12">
                        <DescriptionText>
                            ...
                            ferramentas fundamentais da nossa plataforma, que vai beneficiar toda a
                            sua empresa. Vamos juntos implantar uma cultura de produtividade por
                            meio da tecnologia?
                        </DescriptionText>
                    </Col>
                    <Col lg="6" xs="12">
